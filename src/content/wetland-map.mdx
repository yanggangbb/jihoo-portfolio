...
title: "WETLAND MAP"
date: "2024-10-07"
excerpt: "위성영상과 QGIS를 활용한 습지 면적 변화 분석 및 시각화 프로젝트로, 기후 변화에 대한 대중의 인식 제고를 목표로 합니다."
category: "개발"
...
- 위성 영상 해석 및 GIS 분석 실무 역량 향상  
- Python 기반 데이터 처리 및 시각화 경험  
- React와 KakaoMap API 통합 개발 역량 강화  
- 팀 협업 및 환경 문제 해결을 위한 기술 활용 경험

## 향후 개선 계획

- 실시간 위성 영상 기반 AI 객체 탐지 기능 도입  
- 습지 탄소 저장량 예측 시스템 개발  
- 글로벌 환경 데이터와 연동한 국제 버전 확장

## GitHub

👉 https://github.com/yanggangbb/SW_DemoDay
