...
[[KOR] OpenCPN Launcher Plugin - Command Injection via User-defined Command Execution](./opencpn-rce-command-injection-kor)
...
[OpenCPN Launcher Plugin- 사용자 정의 명령 실행을 통한 명령어 주입 취약점](./opencpn-rce-command-injection-detail)